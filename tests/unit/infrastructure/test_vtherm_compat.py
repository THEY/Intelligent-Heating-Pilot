...
class TestVThermCompatibility(unittest.TestCase):

    def test_get_vtherm_attribute_from_specific_states(self):
    ...
    def test_get_vtherm_attribute_from_root_legacy(self):
    ...
    def test_get_vtherm_attribute_prefers_specific_states(self):
    ...
    def test_get_vtherm_attribute_missing_returns_default(self):
    ...
    def test_get_vtherm_attribute_none_state(self):
    ...
    def test_get_vtherm_attribute_empty_attributes(self):
    ...
    def test_get_vtherm_attribute_specific_states_not_dict(self):
